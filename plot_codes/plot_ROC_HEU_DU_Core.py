...
def plot_ROC(metadata):
    ...
    photon_intensity_DUcore_185_detected = [] # Array consists of values of the form detected_background_emission_185.7keV
    photon_intensity_DUcore_1001_detected = []  # Array consists of values of the form detected_core_emission_185.7keV
    for geometry in metadata.values():
        ...
        photon_intensity_DUcore_185_detected.append(geometry["detected_DUcore_emission_185.7keV"])
        photon_intensity_DUcore_1001_detected.append(geometry["detected_DUcore_emission_1001.0keV"])
    ...
    photon_intensity_DUcore_185_detected = np.array(photon_intensity_DUcore_185_detected)
    photon_intensity_DUcore_1001_detected = np.array(photon_intensity_DUcore_1001_detected)

    # Define the true and false data points for the ROC curve
    hoax_185 = photon_intensity_DUcore_185_detected
    real_185 = photon_intensity_core_185_detected
    hoax_1001 = photon_intensity_DUcore_1001_detected
    real_1001 = photon_intensity_core_1001_detected
    hoax_1001_185 = hoax_1001 / hoax_185
    real_1001_185 = real_1001 / real_185 
