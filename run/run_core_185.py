...
def main():
    ...
    for key, item in metadata.items():
        ...
        # Simulation 3
        core_activity_185, detected_core_emission_185, detectedRadCase_core_emission_185, detectedHE_core_emission_185, detectedReflector_core_emission_185, detectedCore_core_emission_185 = simulate(
            space_thickness,
            gap_thickness,
            ...
            core_emission = True,
            photon_energy = 185.7)
        item["core_activity_185.7keV"] = core_activity_185
        item["detected_core_emission_185.7keV"] = detected_core_emission_185
        item["detectedRadCase_core_emission_185.7keV"] = detectedRadCase_core_emission_185
        item["detectedHE_core_emission_185.7keV"] = detectedHE_core_emission_185
        item["detectedReflector_core_emission_185.7keV"] = detectedReflector_core_emission_185
        item["detectedCore_core_emission_185.7keV"] = detectedCore_core_emission_185  
        
        with open(f"data/temp/core_185/metadata_{key}.json", "w") as f:
