...
def main():
    ...
    for key, item in metadata.items():
        ...
        if not "ca1f0809" in key: continue
        print(key)
        space_thickness = item["space_thickness"]
        gap_thickness = item["gap_thickness"]
        radiationCase_thickness = item["radiationCase_thickness"]
        core_enrichment = item["core_enrichment"]
        radiationCase_enrichment = 0.
        
        # Simulation 4      
        core_activity_1001, detected_core_emission_1001,detectedRadCase_core_emission_1001,detectedHE_core_emission_1001,detectedReflector_core_emission_1001,detectedCore_core_emission_1001 = simulate(
            space_thickness,
            gap_thickness,
        ...
        item["core_activity_1001keV"] = core_activity_1001
        item["detected_core_emission_1001.0keV"] = detected_core_emission_1001
        item["detectedRadCase_core_emission_1001.0keV"] = detectedRadCase_core_emission_1001
        item["detectedHE_core_emission_1001.0keV"] = detectedHE_core_emission_1001
        item["detectedReflector_core_emission_1001.0keV"] = detectedReflector_core_emission_1001
        item["detectedCore_core_emission_1001.0keV"] = detectedCore_core_emission_1001
        
        with open(f"data/temp/core_1001/metadata_{key}.json", "w") as f:
