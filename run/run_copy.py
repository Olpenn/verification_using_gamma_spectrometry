...
def main():
    ...
    for key, item in metadata.items():
        ...
        _, detected_DUcore_emission_185, detectedRadCase_DUcore_emission_185, detectedHE_DUcore_emission_185, detectedReflector_DUcore_emission_185, detectedCore_DUcore_emission_185 = simulate(
            space_thickness,
            gap_thickness,
        ...
        _, detected_DUcore_emission_1001,detectedRadCase_DUcore_emission_1001,detectedHE_DUcore_emission_1001,detectedReflector_DUcore_emission_1001,detectedCore_DUcore_emission_1001 = simulate(
            space_thickness,
            gap_thickness,
            radiationCase_thickness,
            core_enrichment,
            radiationCase_enrichment,
            core_emission = True,
            photon_energy = 1001.0)
        item["detected_DUcore_emission_1001.0keV"] = detected_DUcore_emission_1001
        item["detectedRadCase_DUcore_emission_1001.0keV"] = detectedRadCase_DUcore_emission_1001
        item["detectedHE_DUcore_emission_1001.0keV"] = detectedHE_DUcore_emission_1001
        item["detectedReflector_DUcore_emission_1001.0keV"] = detectedReflector_DUcore_emission_1001
        item["detectedCore_DUcore_emission_1001.0keV"] = detectedCore_DUcore_emission_1001
        with open(f"data/temp/metadata_{key}.json", "w") as f:
