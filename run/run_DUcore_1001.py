...
def main():
    ...
    for key, item in metadata.items():
        ...
        # Simulation 2
        DUcore_activity_1001, detected_DUcore_emission_1001,detectedRadCase_DUcore_emission_1001,detectedHE_DUcore_emission_1001,detectedReflector_DUcore_emission_1001,detectedCore_DUcore_emission_1001 = simulate(
            space_thickness,
            gap_thickness,
        ...
        item["DUcore_activity_1001keV"] = DUcore_activity_1001
        ...
        with open(f"data/temp/DUcore_1001/metadata_{key}.json", "w") as f:
